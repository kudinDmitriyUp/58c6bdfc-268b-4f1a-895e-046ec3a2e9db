...
export const metadata: Metadata = {
  title: "Buildercult - Build Apps with AI & Grow with Short-Form Content",
  description: "Learn how to build consumer apps using AI and grow them with short-form content strategies. Education platform for indie hackers, creators, and founders.",
  keywords: ["app building", "AI tools", "short-form content", "indie hackers", "founders", "TikTok growth", "no-code"],
  metadataBase: new URL("https://buildercult.com"),
  alternates: {
    canonical: "https://buildercult.com"
  },
  openGraph: {
    title: "Buildercult - Build Apps with AI & Grow with Content",
    description: "The AI-first education platform teaching builders how to launch apps and scale them using faceless content systems.",
    siteName: "Buildercult",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_36r0PgQZzhj8jQqh48LKsIG58we/uploaded-1765802831774-6bzpumsw.jpg",
      alt: "Buildercult - Build and grow apps with AI"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Buildercult - Build Apps with AI & Grow with Content",
    description: "Learn to build apps using AI and scale them with short-form content strategies.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_36r0PgQZzhj8jQqh48LKsIG58we/uploaded-1765802831774-6bzpumsw.jpg"]
  },
  robots: {
    index: true,
    follow: true
